...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|
     KC_LCTL,  LG(KC_A), LA(KC_S), LC(KC_D), KC_F,     KC_G,            KC_H,     KC_J,     RC(KC_K), RA(KC_L),RG(KC_SCLN),KC_QUOT,\
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|
  ...
  [_RAISE] = LAYOUT( \
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|
     KC_TRNS,  KC_EXLM,  KC_AT,    KC_LPRN,  KC_RPRN,  KC_AMPR,         KC_PMNS,  KC_7,     KC_8,     KC_9,     KC_PSLS,  KC_TRNS, \
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|
     KC_TRNS,  KC_HASH,  KC_DLR,   KC_LBRC,  KC_RBRC,  KC_ASTR,         KC_PPLS,  KC_4,     KC_5,     KC_6,     KC_PAST,  KC_TRNS, \
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|  
     KC_TRNS,  KC_PERC,  KC_CIRC,  KC_LCBR,  KC_RCBR,  KC_TRNS,         KC_PDOT,  KC_1,     KC_2,     KC_3,     KC_PEQL,  KC_TRNS, \
  //|---------+---------+---------+---------+---------+---------|      |---------+---------+---------+---------+---------+---------|
